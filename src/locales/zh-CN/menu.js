export default {
  ...
  // 个人配置
  'menu.gamelist': '游戏列表',
  'menu.gamelist.goodslist': '游戏商品',
  'menu.gamelist.mobilegames': '手游列表',
  'menu.gamelist.searchlist': '搜索列表',
  'menu.settings': '个人中心',
  'menu.index': '首页',
  'menu.transaction': '交易',
  'menu.transaction.mytransaction': '我的交易',
  'menu.transaction.alltransaction': '全部交易'
};
